...
network_training_output_dir_base = os.path.join(os.environ['RESULTS_FOLDER_nnFormer']) if "RESULTS_FOLDER_nnFormer" in os.environ.keys() else None
...
if network_training_output_dir_base is not None:
    ...
    print("RESULTS_FOLDER_nnFormer is not defined and nnU-Net cannot be used for training or "
